...
var getCurrentProfile = function getCurrentProfile() {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.get(environment.backendUrl + "/v1/profile")).then(function (res) {
...
var updateProfilePicture = function updateProfilePicture(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(environment.backendUrl + "/v1/profile/picture", payload)).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
...
var updateBasicInfo = function updateBasicInfo(data) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(environment.backendUrl + "/v1/profile", data)).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
...
var getProvinces = function getProvinces() {
  try {
    return Promise.resolve(_catch$1(function () {
      return Promise.resolve(axios$1$1.get(environment$1.backendUrl + "/v1/province")).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
...
axios$1$1.defaults.headers.common["Content-Type"] = "application/json";
...
function Profile(props) {
  ...
  var _useState7 = React$1.useState(new Array()),
  ...
  return /*#__PURE__*/React$1__default.createElement(GlobalContent, null, /*#__PURE__*/React$1__default.createElement(FormTitle, null, "Actualizar Perfil"), /*#__PURE__*/React$1__default.createElement(Form, null, /*#__PURE__*/React$1__default.createElement(FormInput, {
    label: "Nombre",
    name: "name",
    value: name,
    ...
    className: "form-group"
  }, /*#__PURE__*/React$1__default.createElement("label", null, "Profile Picture"), /*#__PURE__*/React$1__default.createElement(ImageUpload, {
    src: getPictureUrl(picture),
    onChange: uploadPicture
  }), /*#__PURE__*/React$1__default.createElement(ErrorLabel, {
    message: errorHandler.getErrorText("name")
  })), /*#__PURE__*/React$1__default.createElement(FormInput, {
    label: "Email",
    name: "email",
    value: email,
    onChange: function onChange(e) {
    ...
    className: "form-group"
  }, /*#__PURE__*/React$1__default.createElement("label", null, "Provincia"), /*#__PURE__*/React$1__default.createElement("select", {
    value: province,
    onChange: function onChange(e) {
    ...
    errorHandler: errorHandler
  }), /*#__PURE__*/React$1__default.createElement(DangerLabel, {
    message: errorHandler.errorMessage
  }), /*#__PURE__*/React$1__default.createElement(FormButtonBar, null, /*#__PURE__*/React$1__default.createElement(FormAcceptButton, {
    label: "Actualizar",
    onClick: updateClick
  }), /*#__PURE__*/React$1__default.createElement(FormButton, {
    label: "Cancelar",
