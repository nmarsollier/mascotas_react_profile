...
var getCurrentProfile = function getCurrentProfile() {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.get(environment.backendUrl + "/v1/profile")).then(function (res) {
...
var updateProfilePicture = function updateProfilePicture(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/profile/picture", payload)).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
...
var updateBasicInfo = function updateBasicInfo(data) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/profile", data)).then(function (res) {
        return Promise.resolve(res.data);
      });
    }, function (err) {
      return Promise.reject(err);
